...
<head>
     ...
     <link rel="icon" type="image/png" sizes="32x32" href="statics/bank.png">
     <link rel="icon" type="image/png" sizes="16x16" href="statics/bank.png">
...
<body style="background-color:#5da9f5;">

     <div id="lock"><img src="statics/PngItem_5146697.png" alt="" style="width:50%; margin-top:50%;"><br>
          <h1 style="color:black; margin-top: 25px;"><b>Please rotate the device. </b><br>We support only landscape
               mode.</h1>
     </div>
     ...
     <div id="container">
          ...
          <div class="container-large"
               style="color:white; height:600px; width: 100%; padding:8% 2% 2% 2%; background-color:#002448;">
               <div class="row">
                    ...
                    <div class="col" style="margin:-2% 0% 0% 2%; text-align:center;">
                         &nbsp;<img src="statics/finance1-removebg-preview.png" class="zoomin" alt=""
               ...
               <div class="container"
                    ...
                    <div class="container" style="margin:30px 0px 20px 0px;">
                         <div class="row">
                              <div class="col-lg">
                                   <div
                                        style="background-color:#002448; color:white; width: 90%; border-radius:30px; box-shadow:3px 3px 8px gray; padding:20px 10px 20px 10px;">
                                        <i class="fas fa-users fa-7x"></i><br><br>
                                        <a href="all_cust.php"><button type="button"
                                                  class="btn btn-outline-light mybtn">View
